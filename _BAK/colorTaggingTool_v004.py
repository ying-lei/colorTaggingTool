...
class ColorTaggingUI(QtWidgets.QDialog):
	""" Main UI
	"""
	...
	def __init__(self, parent = None):
		...
		# Label
		self.outlinerLabel = QtWidgets.QLabel("Choose Outliner Color")
		self.verticalLayout.addWidget(self.outlinerLabel)

		# button grid 01
		self.buttonGridLayout_1 = QtWidgets.QGridLayout()
		self.buttonGridLayout_1.setHorizontalSpacing(1)
		self.buttonGridLayout_1.setVerticalSpacing(1)

		self.outlinerButtonGrp = QtWidgets.QButtonGroup()
		...
		# sync checkbox
		self.syncColorCheckBox = QtWidgets.QCheckBox("Sync outliner color and wireframe color")
		self.verticalLayout.addWidget(self.syncColorCheckBox)



		self.emptySpace_2 = QtWidgets.QLabel("")
		self.verticalLayout.addWidget(self.emptySpace_2)


		# Disable All Btn
		self.disableAllBtn = QtWidgets.QPushButton("Disable All On Selections")
